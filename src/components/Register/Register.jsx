...
export default function Register() {
    ...
    async function sendRegisterData(values) {
        try {
            ...
            } else setError(err.response.data.validationError);
                ...
                >
                    <form action="#" onSubmit={handleSubmit}>
                        ...
                        <input
                            ...
                            onBlur={handleBlur}
                            className={
                                errors.userName && touched.userName ? "is-invalid " : "is-valid"
                            }
                        />
                        {errors.userName && touched.userName ? (
                            <p className="m-0 p-0  text-danger">{errors.userName}</p>
                        ) : (
                            ""
                        )}
                        <input
                        ...
                        {errors.email && touched.email ? (
                            <p className="m-0 p-0  text-danger">{errors.email}</p>
                        ) : statusError ? (
                        ...
                        {errors.cPassword && touched.cPassword ? (
                            <p className="m-0 p-0  text-danger">{errors.cPassword}</p>
                        ) : (
                            ""
                        )}
                        <div className="d-flex align-items-center justify-content-center terms my-3 ms-0">
                            ...
                            <p className="p-0 m-0">
                                I accept all <span className="text-primary">terms</span> &{" "}
